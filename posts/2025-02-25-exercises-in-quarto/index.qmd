...
I want to acknowledge all those folks generating the tools I describe above - even if a this point, none are exactly doing what I'm looking for 😁. 
...
Which will result in this output in your rendered Quarto document:
...
Or do an inline question like this:
