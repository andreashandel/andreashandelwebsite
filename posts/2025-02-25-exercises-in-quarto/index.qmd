...
[^3]: Without havine tried each, that's just my impression after reading through some of the documentation.
...
[^4]: It [seems to be possible](https://yabellini.netlify.app/blog/2024-09-29-quarto_live_quiz/) to do it, but that approach looks too tedious to me.
