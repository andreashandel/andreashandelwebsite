...
_Update 2022-09-25: Distill is in my opinion at this point outdated and replaced by [`Quarto`](https://quarto.org/). Going forward, I recommend using the `Quarto` framework._
...
Ok, the 30 minute timer starts now `r emoji::emoji('grin')`. With the above registration and installation bits out of the way, you can get started with your website. To do so, follow these steps:
...
**That's it. Now the hard part starts, creating good content. `r emoji::emoji('smile')`**
